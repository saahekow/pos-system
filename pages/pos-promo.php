...
$pageTitle='POS Promo';$breadcrumbs=[['label'=>'Home','url'=>app_url('index.php')],['label'=>'POS','url'=>app_url('pos.php')],['label'=>'Direct Sales','url'=>app_url('pos.php?view=sales')],['label'=>'Promo']];$internalBackUrl=requested_return_url(app_url('pos.php?view=sales'));require __DIR__.'/../includes/header.php';
?>
...
<div class="form-actions"><a class="secondary-button" href="<?=e($internalBackUrl)?>"><i class="fa-solid fa-arrow-left"></i><span>Back</span></a><button class="login-button" type="submit"><i class="fa-solid fa-floppy-disk"></i><span>Save Promo</span></button></div></form></section>
