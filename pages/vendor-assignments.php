...
if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if($error===''){db()->beginTransaction();try{
        ...
        db()->commit();$message='Vendor managed towns updated successfully.';
...
?>
<section class="management-panel"><div class="management-heading"><div><span class="section-kicker">Admin</span><h1>Vendor Assignments</h1><p>All vendor menus are assigned automatically except Data Management. Manage the towns where each vendor may access customers.</p></div><div class="management-icon"><i class="fa-solid fa-store"></i></div></div>
